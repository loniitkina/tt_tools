...
#CS2 = plt.contourf(rot_x, rot_y, arr.T, 30, vmax=1., vmin=0,cmap=plt.cm.binary_r,alpha=.5)
...
for i in range(0,len(flist)):
    ...
    if date=='20200107' and loc=='special':
        ax.plot(xx,yy,'o',ms=5,label='dark FYI',c='darkkhaki')
    #dark side SYI
    ...
    if date=='20200228':
        if loc=='ridgeA1':
            ax.plot(xx,yy,'o',ms=5,label='ridge',c='limegreen')
        else:
